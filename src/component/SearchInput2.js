...
//  elevation: 5,
        ...
        <TextInput
         style={[styles.input,{paddingLeft: props.paddingLeft ? props.paddingLeft : 5 ,left: props.inputLeft ? props.inputLeft : 'auto'}]}
    ...
    <Image source={props.searchImage ? props.searchImage : require('../assets/Search-red.png')} style={{ width: 45, height: 49, alignSelf: 'center'}}></Image>
    </TouchableOpacity>
